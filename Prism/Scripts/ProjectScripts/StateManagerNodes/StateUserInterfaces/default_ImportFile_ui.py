...
class Ui_wg_ImportFile(object):
    def setupUi(self, wg_ImportFile):
        ...
        self.f_name = QWidget(wg_ImportFile)
    ...
    def retranslateUi(self, wg_ImportFile):
        ...
        self.l_name.setText(QCoreApplication.translate("wg_ImportFile", u"State name:", None))
        ...
        self.l_keepRefEdits.setText(QCoreApplication.translate("wg_ImportFile", u"Keep Reference Edits:", None))
        ...
        self.l_abcPath.setText(QCoreApplication.translate("wg_ImportFile", u"Alembic - Update path only (if exists)", None))
        self.chb_abcPath.setText("")
        self.l_trackObjects.setText(QCoreApplication.translate("wg_ImportFile", u"Keep track of connected objects:", None))
        self.chb_trackObjects.setText("")
        self.gb_objects.setTitle(QCoreApplication.translate("wg_ImportFile", u"Objects", None))
        self.b_selectAll.setText(QCoreApplication.translate("wg_ImportFile", u"Select all", None))
    # retranslateUi
